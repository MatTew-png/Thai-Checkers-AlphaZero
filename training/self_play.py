...
class SelfPlayWorker:
    def __init__(self, model: ThaiCheckersNet, mcts_simulations: int = 100):
        self.model = model
    ...
    def play_game(
        ...
        # History stores: (canonical_tensor, pi_distribution, active_player)
        ...
        while not done:
            ...
            # Record step
            episode_data.append((state_tensor, pi, board.current_player))
